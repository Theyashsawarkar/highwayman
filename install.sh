...
REPO_URL="${HIGHWAYMAN_REPO_URL:-https://github.com/Theyashsawarkar/highwayman.git}"
ARCHIVE_URL="${HIGHWAYMAN_ARCHIVE_URL:-https://github.com/Theyashsawarkar/highwayman/archive/refs/heads/main.tar.gz}"
